...
│  JarvisAgent (Anthropic SDK, native loop without ADK)                  │
│                                                                         │
...
│   │
│   ├── brain/
│   │   ├── agent.py             # JarvisAgent (Anthropic SDK) — native loop without ADK + guardrails
│   │   ├── adk_universal.py     # JarvisUniversalADKAgent (ADK + LiteLLM multi-provider) + guardrails
